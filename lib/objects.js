(function () {
    ...
    Object["typeof"] = __typeof = function (val) {
    ...
    if (!Object.prefixKeys) {
        Object.prefixKeys = function(obj, prefix, ignore_keys) {
    ...
    if (!Object.remPrefixKeys) {
        Object.remPrefixKeys = function(obj, prefix, ignore_keys) {
            ignore_keys = ignore_keys || [];
            var i,
