(function () {
    ...
    module.exports.diff = function (obj) {
        ...
        for (k1 in obj) {
            ...
            for (i = 1; i < argl && !found; ++i) {
                if (obj[k1] instanceof Date && arguments[i][k1] instanceof Date) {
                    if (obj[k1].getTime() === arguments[i][k1].getTime()) {
                        found  = true;
                    }
                } else if (obj[k1] === arguments[i][k1]) {
                    found  = true;
                }
            }
    ...
    module.exports.get = __get = function (obj, key) {
        var keys,
            cobj = obj,
            i,
            max,
